...
Application::Application(): vao(0), vbo(0), ebo(0), delta_time(0), last_frame(0)
{
...
void Application::setupShape()
{
    ...
    // position attribute
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 5 * sizeof(float), static_cast<void *>(nullptr)); // location = 0
