...
class Shader {
    ...
    int ul_light_constant, ul_light_linear, ul_light_quadratic;
...
public:
    ...
    void SetUniformLight(glm::vec3 light_position, glm::vec3 ambience, glm::vec3 diffuse, glm::vec3 specular,
